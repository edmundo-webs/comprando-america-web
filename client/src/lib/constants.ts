...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer: "El Grupo Empresarial de Edmundo incluye acceso a los 6 pilares: Deal Day, Deal Finding, Americaniza tu Operación, Visa a la Medida, Círculo Experto y Real Estate Optimizado. Además, apertura de empresa y cuentas bancarias, inversiones exclusivas, consultorías 1:1, y construcción de crédito para extranjeros.",
  },
  {
  ...
  {
    question: "¿Cuánto dura el Grupo Empresarial de Edmundo?",
    answer: "El Grupo Empresarial de Edmundo es vitalicio. Una vez que eres aceptado, tienes acceso permanente a todos los beneficios y recursos de la comunidad.",
  },
];
