        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Grupo Empresarial de Edmundo — comunidad privada de empresarios e inversionistas latinos enfocada en estructura, estrategia y ejecución en Estados Unidos.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><a href="/membresia" className="text-white/50 hover:text-blue-400 text-sm transition-colors">Grupo Empresarial de Edmundo</a></li>
