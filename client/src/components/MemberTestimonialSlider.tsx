...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Eduardo",
    city: "Ciudad de México",
    quote: "El networking dentro de el Grupo Empresarial de Edmundo abre puertas que de otra forma tomarían años.",
    initials: "E",
  ...
  },
  {
    ...
    name: "David",
    city: "Ciudad de México",
    quote: "Las mentorías dentro de el Grupo Empresarial de Edmundo ayudan a entender cómo funciona realmente el mercado en Estados Unidos.",
    initials: "D",
  ...
  },
  {
    ...
    name: "Mauricio",
    city: "Monterrey",
    quote: "La estructura de el Grupo Empresarial de Edmundo está pensada para empresarios que quieren ejecutar.",
    initials: "M",
  ...
  },
  {
    ...
    name: "Enrique",
    city: "Houston",
    quote: "Poder analizar oportunidades con otros inversionistas dentro de el Grupo Empresarial de Edmundo es muy valioso.",
    initials: "E",
