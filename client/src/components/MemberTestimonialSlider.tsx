...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    name: "Eduardo",
    city: "Ciudad de México",
    quote: "El networking dentro de el Círculo Cercano abre puertas que de otra forma tomarían años.",
    initials: "E",
  ...
  },
  {
    ...
    name: "David",
    city: "Ciudad de México",
    quote: "Las mentorías dentro de el Círculo Cercano ayudan a entender cómo funciona realmente el mercado en Estados Unidos.",
    initials: "D",
  ...
  },
  {
    ...
    name: "Mauricio",
    city: "Monterrey",
    quote: "La estructura de el Círculo Cercano está pensada para empresarios que quieren ejecutar.",
    initials: "M",
  ...
  },
  {
    ...
    name: "Enrique",
    city: "Houston",
    quote: "Poder analizar oportunidades con otros inversionistas dentro de el Círculo Cercano es muy valioso.",
    initials: "E",
