...
export default function Recursos() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      {/* ═══ 2. TABS SELECTOR ═══ */}
      <section className="section-darker py-12 md:py-16 sticky top-0 z-30 backdrop-blur-lg bg-[oklch(0.10_0.02_260)]/90 border-b border-white/5">
                ...
                <div className="max-w-5xl mx-auto">
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                    {episodes.map((ep, i) => (
                      ...
                      >
                        <div className="group bg-[oklch(0.12_0.03_250)] border border-white/10 rounded-xl overflow-hidden hover:border-primary/30 transition-all">
                  ...
                  {loadingNews ? (
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div
                          key={i}
                          className="bg-[oklch(0.12_0.03_250)] border border-white/10 rounded-xl h-64 animate-pulse"
                        />
                      ))}
                    </div>
                  ) : news.length > 0 ? (
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                      {news.map((article: any) => (
                        <Link key={article.id} href={`/news/${article.slug}`}>
                          <div className="group bg-[oklch(0.12_0.03_250)] border border-white/10 rounded-xl overflow-hidden hover:border-primary/30 transition-all h-full cursor-pointer">
                            {article.imageUrl && (
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                <a href="/membresia">
                  <div className="bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-5 hover:border-primary/20 transition-all text-center">
                    <p className="text-primary text-sm font-semibold mb-1">
                      Membresía
                    </p>
                    <p className="text-white/40 text-xs">Comunidad privada</p>
                  </div>
                </a>
                <a href="/oportunidades-de-inversion-en-estados-unidos">
                  <div className="bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-5 hover:border-primary/20 transition-all text-center">
                    ...
                    <p className="text-white/40 text-xs">Acceso filtrado</p>
                  </div>
                </a>
                <a href="/llc">
                  <div className="bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-5 hover:border-primary/20 transition-all text-center">
                    ...
                    <p className="text-white/40 text-xs">LLC en EE.UU.</p>
                  </div>
                </a>
              </div>
            </div>
