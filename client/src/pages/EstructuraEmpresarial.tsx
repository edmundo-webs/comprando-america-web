      ...
      <section className="section-dark py-20 md:py-28">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <FadeIn>
              <div className="bg-gradient-to-br from-[oklch(0.15_0.03_250)] to-[oklch(0.12_0.03_250)] border border-primary/20 rounded-2xl p-8 h-full">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <FadeIn key={i} delay={i * 0.05}>
                    <div className="flex items-start gap-4 bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-5 hover:border-primary/20 transition-all">
        ...
        <div className="container">
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="inline-block bg-gradient-to-br from-[oklch(0.15_0.03_250)] to-[oklch(0.12_0.02_260)] border border-primary/30 rounded-2xl p-10 mb-10">
                <p className="text-5xl md:text-6xl font-serif text-white font-bold mb-2">
                  $1,499{" "}
                  <span className="text-white/40 text-2xl font-normal">
                    USD
                  </span>
                </p>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-6 h-full">
