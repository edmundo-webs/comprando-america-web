      ...
      <section className="relative pt-28 pb-16 md:pt-32 md:pb-20">
        ...
        <div className="container relative z-10">
          <a href="/#blog">
            <Button
              variant="ghost"
              className="text-white/60 hover:text-white hover:bg-white/5 mb-8 gap-2 -ml-2"
            >
        ...
        <section className="container pb-24 md:pb-32">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="border-t border-white/10 mt-16 pt-12">
              <div className="bg-[oklch(0.14_0.02_264)] border border-white/5 rounded-2xl p-8 md:p-10 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  ...
                  <a href="/#blog">
                    <Button variant="outline" className="border-white/20 text-white hover:bg-white/5 px-8 py-5">
                      Ver más artículos
                    </Button>
                  </a>
                </div>
