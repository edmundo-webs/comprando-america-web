...
export default function InvestmentWeek() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <div className="bg-[oklch(0.10_0.02_260)] border-b border-primary/20 pt-20">
        ...
        <div className="container relative z-10">
          <FadeIn>
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold tracking-wider uppercase mb-8">
              ...
              <p className="text-xl md:text-2xl font-serif text-white/70 mb-6">
      ...
      <section className="section-darker py-20 md:py-28">
        <div className="container">
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            {/* DÍA 1 */}
            <FadeIn>
              <div className="relative bg-gradient-to-br from-[oklch(0.14_0.03_250)] to-[oklch(0.11_0.02_260)] border border-primary/20 rounded-2xl overflow-hidden">
                <div className="grid lg:grid-cols-[280px_1fr]">
                  <div className="bg-primary/10 p-8 flex flex-col justify-center border-r border-primary/10">
            ...
            {/* DÍA 4 */}
            <FadeIn>
              <div className="relative bg-[oklch(0.13_0.02_250)] border border-white/10 rounded-2xl overflow-hidden">
                <div className="grid lg:grid-cols-[280px_1fr]">
                  <div className="bg-white/5 p-8 flex flex-col justify-center border-r border-white/5">
                    <p className="text-primary text-xs font-semibold tracking-[0.3em] uppercase mb-2 font-mono">
                      Día 4
                    </p>
        ...
        <div className="container">
          <FadeIn>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-[oklch(0.10_0.02_260)] border border-primary/20 rounded-xl p-8">
                <p className="text-white/80 text-lg font-serif">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  ...
                  <FadeIn key={i} delay={i * 0.05}>
                    <div className="flex items-start gap-4 bg-[oklch(0.15_0.03_250)] border border-white/5 rounded-xl p-5">
