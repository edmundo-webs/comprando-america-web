        ...
        <div className="container">
          ...
          <FadeIn delay={0.1}>
            <div className="max-w-4xl mx-auto">
              <div className="relative rounded-2xl overflow-hidden border border-[#1E3A5F] bg-black">
                <video
      ...
      <section className="section-dark py-24 md:py-32">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <FadeIn delay={0.2}>
              <div className="bg-gradient-to-br from-primary/10 to-emerald/10 border border-blue-500/20 rounded-2xl p-8">
                ...
                <p className="text-white/60 mb-6">USD para acceder a oportunidades filtradas y acompañamiento profesional</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {commonMistakes.map((mistake, i) => (
              <FadeIn key={mistake.title} delay={i * 0.1}>
                <div className="bg-[#132D50] border border-red-500/20 rounded-xl p-6 hover:border-red-500/40 transition-all duration-500">
        ...
        <div className="container max-w-3xl">
          ...
          <FadeIn>
            <Accordion type="single" collapsible className="space-y-4">
              {faqs.map((faq, i) => (
                <AccordionItem key={i} value={`item-${i}`} className="bg-[#132D50] border border-[#1E3A5F] rounded-lg px-6">
                  ...
                  <AccordionContent className="text-white/60 pb-4">{faq.answer}</AccordionContent>
                </AccordionItem>
              ))}
            </Accordion>
          </FadeIn>
