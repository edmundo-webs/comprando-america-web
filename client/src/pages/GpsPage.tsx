...
const PERFILES: Record<string, { nombre: string; descripcion: string; vehiculos: string[]; porQueEncaja: string }> = {
  patrimonio: {
    ...
    porQueEncaja: "Tus respuestas indican que buscas protección y crecimiento sostenido. Esta ruta prioriza estructuras legales sólidas y activos con baja volatilidad en dólares.",
    vehiculos: ["Victory Capital", "Fondos & Estructuras", "Real Estate", "Círculo Cercano"],
  },
  ingresos: {
    ...
    porQueEncaja: "Buscas activos que generen flujo mensual sin requerir tu presencia. Esta ruta conecta con vehículos de renta pasiva y gestión profesional en dólares.",
    vehiculos: ["Victory Capital", "Section 8", "Coinversiones", "Círculo Cercano"],
  },
  empresa: {
    ...
    porQueEncaja: "Tu perfil indica capacidad operativa y visión de expansión. Esta ruta se diseña para llevar tu empresa al mercado americano con estructura sólida.",
    vehiculos: ["Americaniza tu Operación", "Fondos & Estructuras", "Adquisiciones", "Círculo Cercano"],
  },
  familia: {
    ...
    vehiculos: ["Círculo Cercano", "Fondos & Estructuras", "Real Estate", "Visa E-2"],
  },
  explorar: {
    ...
    porQueEncaja: "Antes de invertir, el mayor activo es el criterio. Esta ruta te da el mapa completo para tomar decisiones informadas sin apresurarte.",
    vehiculos: ["Círculo Cercano", "Mapa de Rutas", "Comunidad", "Biblioteca GPS"],
  },
};
