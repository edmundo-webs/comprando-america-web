...
const ROADMAP_STEPS = [
  ...
  },
  {
    ...
    label: "Ejecución",
    desc: "Deal Day",
    detail: "El punto fuerte de la membresía. Accedes a propiedades fuera del mercado con precios y condiciones exclusivas.",
    icon: "🔑",
  },
  {
    id: "D",
    ...
    <div className="py-20 px-4 border-t border-white/8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-8 rounded-2xl border border-[#368A45]/30 bg-[#368A45]/8 p-6 text-center">
          <p className="text-white/60 text-sm mb-1">Inversión en la membresía</p>
