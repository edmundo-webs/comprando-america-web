          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-base text-white/60 leading-relaxed mb-10 max-w-2xl">
                Este contenido grabado forma parte de tu Círculo Cercano anual y te entrega las bases que necesitas para tomar decisiones informadas, entender las estructuras legales y financieras del mercado, y avanzar con acompañamiento real.
              </p>
              <a href="#formulario">
