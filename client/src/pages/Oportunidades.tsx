    ...
    <div className="min-h-screen bg-[#0B1F3A] text-white overflow-x-hidden">
      ...
      <section className="bg-[#F5F7FA] py-20 md:py-28">
        <div className="container">
          <FadeIn>
            <div className="max-w-3xl mx-auto text-center">
              <p className="text-primary text-sm font-semibold tracking-[0.25em] uppercase mb-4 font-mono">Círculo Cercano de Edmundo Treviño</p>
              <h2 className="text-3xl md:text-4xl text-[#0B1F3A] mb-6">
                La mayoría de las oportunidades se presentan dentro de el Círculo Cercano
              </h2>
