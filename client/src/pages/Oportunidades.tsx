            ...
            <div className="max-w-3xl">
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                <Button
                  ...
                  className="bg-primary hover:bg-primary/90 text-white px-8 py-6 text-base gap-2 shadow-lg shadow-primary/20"
                >
          ...
          <FadeIn>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-gradient-to-br from-[oklch(0.14_0.03_250)] to-[oklch(0.11_0.02_260)] border border-primary/30 rounded-2xl p-10 md:p-14">
                  {/* Badge */}
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-semibold tracking-wider uppercase mb-8">
        ...
        <div className="container">
          <FadeIn>
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-[oklch(0.12_0.03_250)] border border-white/10 rounded-xl p-8">
      ...
      <section className="section-darker py-20 md:py-28">
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Card 1 — Active */}
            <FadeIn>
              <div className="relative bg-gradient-to-br from-[oklch(0.15_0.03_250)] to-[oklch(0.12_0.03_250)] border border-primary/20 rounded-2xl p-8 h-full group hover:border-primary/40 transition-all">
            ...
            {/* Card 2 — Coming Soon */}
            <FadeIn delay={0.1}>
              <div className="relative bg-[oklch(0.13_0.02_250)] border border-white/10 rounded-2xl p-8 h-full opacity-80">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 text-white/50 text-xs font-semibold uppercase tracking-wider mb-6">
                  <span className="w-2 h-2 rounded-full bg-white/30" />
                  Próximamente
                </div>

                <TrendingUp className="w-10 h-10 text-white/30 mb-4" />
      ...
      <section className="section-dark py-20 md:py-28">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            {/* Para quién NO es */}
            <FadeIn delay={0.1}>
              <div className="bg-[oklch(0.12_0.02_250)] border border-white/10 rounded-xl p-8 h-full">
                <XCircle className="w-8 h-8 text-white/30 mb-4" />
                <h3 className="text-2xl font-serif text-white/70 mb-6">
                  No es para quienes:
                </h3>
                <div className="space-y-3">
                  {[
