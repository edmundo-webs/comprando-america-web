            ...
            <div className="max-w-2xl mx-auto relative">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#F5F7FA] border border-gray-200 rounded-lg pl-12 pr-4 py-3 text-white placeholder-white/40 focus:outline-none focus:border-primary/50 transition-colors"
                />
              </div>
            </div>
          </FadeIn>
                    ...
                    <FadeIn key={blog.id} delay={i * 0.05}>
                      <Link href={`/blog/${blog.slug}`}>
                        <a className="group h-full block">
                          <div className="relative bg-[#F5F7FA] border border-gray-200 rounded-xl overflow-hidden hover:border-blue-300 transition-all duration-500 h-full flex flex-col">
                            {/* Image */}
                            {blog.featuredImage && (
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                              ...
                              {/* Title */}
                              <h3 className="text-xl font-serif text-[#0B1F3A] mb-3 group-hover:text-primary transition-colors line-clamp-3">
                                {blog.title}
                              </h3>
