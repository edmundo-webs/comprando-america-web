                  ...
                  <form onSubmit={handleSubmit} className="space-y-8 bg-[#132D50] border border-[#1E3A5F] rounded-2xl p-8">
                    ...
                    {currentStep === 1 && (
                      <>
                        ...
                        <div className="pt-6 border-t border-[#1E3A5F] flex gap-4">
                          <Button
                            type="button"
                            onClick={() => {
                      ...
                      <>
                        ...
                        <div className="pt-6 border-t border-[#1E3A5F] flex gap-4">
                          <Button
                            ...
                            variant="outline"
                            className="flex-1 border-[#2A4A6B] text-white hover:bg-[#1E3A5F] py-6 text-base"
                          >
                            Anterior
                          </Button>
                          <Button
              ...
              <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="border-[#2A4A6B] text-white hover:bg-[#1E3A5F] font-semibold px-8 py-6 text-base"
                  >
                    Estoy explorando
                  </Button>
                </div>
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-[#132D50] border border-[#1E3A5F] rounded-2xl p-8 md:p-12 mb-12">
                  <div className="text-center mb-12">
                    ...
                    <div className="inline-block bg-blue-500/15 rounded-full px-6 py-3 mb-8">
